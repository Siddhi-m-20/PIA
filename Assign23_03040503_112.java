...
public class Assign23_03040503_112 {
	public static Scanner sc = new Scanner(System.in);
	public static Random random = new Random();

	public static void main(String args[]) throws IOException, FileNotFoundException {
		String filename = "C:\\Siddhi\\Maths_Excelsheet\\VML_03040503_112_Assign23_Siddhi.xlsx";
		...
		do {
			...
			if (chr11 != chr && chr1 != chr2 && checkIfNoCommonFactor(a, b)) {
				...
				String Question = "Identify the quadratic polynomials in one variable from the following expressions .<br>#खाली दिलेल्या बैजिक राशींमधून अशा राशी शोधा ज्या एका चलातील वर्ग बहुपदी आहेत.<br> ";
				String Correct_ans1 = "";
				String Correct_ans2 = "";
				...
				case 2:
					...
					break;
				case 3:
					Correct_ans1 = "$" + a + ch2 + "^2 -" + b + ch2 + "-" + c + "$";
					break;
				}
				switch (corr) {
				case 0:
					Correct_ans2 = "$" + d + ch + "^2 -" + e + ch + "$";
					break;
				case 1:
					Correct_ans2 = "$" + d + ch3 + "^2 +" + e + "$";
					break;
				case 2:
					Correct_ans2 = "$" + d + ch1 + "^2 +" + e + ch1 + "$";
					break;
				case 3:
				...
				String wrong_ans2 = "$" + d + ch11 + "^2 -" + c + ch + "-" + e + "$<br>";
				String wrong_ans3 = "$" + b + ch1 + "^3+" + f + ch2 + "+" + g + "$<br>";
				String wrong_ans4 = "$" + h + ch3 + "+" + d + ch3 + "^2-" + k + ch3 + "^3$<br>";
				String wrong_ans5 = "$" + b + ch + "^2 +" + k + ch11 + "$<br>";
				String wrong_ans6 = "$" + k + ch2 + "-" + g + ch1 + "+" + h + "$<br>";
				String Solution = "Ans $1$ :  " + Correct_ans1 + " <br>Ans $2$ :  " + Correct_ans2
						+ " <br>For any expression to be a quadratic polynomial in one variable, it must satisfy following three conditions simultaneously. <br> $i)$ It must be in one variable only.<br>$ii)$ The highest power of the variable in the expression must be two. <br> $iii)$ The coefficient of the term with the power $2$ must not be zero. <br>From the given options only  "
						+ Correct_ans1 + " and  " + Correct_ans2
						+ " satisfies the above three conditions.<br>All the other options do not satisfy at least one of the conditions mentioned above.<br>Hence<br>Correct answers $1)$ "
						+ Correct_ans1 + " and <br>Correct answer $2)$  " + Correct_ans2 + " <br>#उत्तर  $1)$   "
						+ Correct_ans1 + "<br>उत्तर  $2)$  " + Correct_ans2
						+ " <br>कोणतीही बैजिक राशी एका चलातील वर्ग राशी असण्यासाठी, खालील तीन अटींचे पालन होणे आवश्यक आहे. <br>$i)$ यात एकच चल असावा. <br>$ii)$ या राशी मधील चलाचा मोठ्यात मोठा घातांक दोन असावा. <br>$iii)$ दोन घातांक असलेल्या पदातील सहगुणक कधीही शून्य नसावा. <br>  या नुसार दिलेल्या पर्यायांपैकी फक्त  "
						+ Correct_ans1 + " आणि   " + Correct_ans2
						+ " या दोन राशी आवश्यक तीनही अटींची पूर्तता करतात.  <br>इतर सर्व राशी या पैकी किमान एक तरी अट पूर्ण करत नाहीत. म्हणून <br>बरोबर उत्तर  $1)$   "
						+ Correct_ans1 + " आणि <br> बरोबर उत्तर $2)$  " + Correct_ans2 + " <br>";
