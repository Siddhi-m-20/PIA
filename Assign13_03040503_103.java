...
public class Assign13_03040503_103 {
	public static Scanner sc = new Scanner(System.in);
	public static Random random = new Random();

	public static void main(String args[]) throws IOException, FileNotFoundException {
		String filename = "C:\\Siddhi\\Maths_Excelsheet\\VML_03040503_103_Assign13_Siddhi.xlsx";
		...
		do {
			...
			if (chr11 != chr && chr1 != chr2 && checkIfNoCommonFactor(a, b)) {
				...
				String Question = "Identify the quadratic polynomial in one variable from the following expressions.<br>#खाली दिलेल्या बैजिक राशींमधून अशी राशी शोधा जी एका चलातील वर्ग बहुपदी आहे.<br>";
				String Correct_ans = "";
				int corr = random.nextInt(8);
				switch (corr) {
				case 0:
					Correct_ans = "$" + a + ch + "^2 +" + b + ch + "+" + c + "$";
					break;
				case 1:
					Correct_ans = "$" + a + ch1 + "^2 -" + b + ch1 + "+" + c + "$";
					break;
				case 2:
					Correct_ans = "$" + a + ch11 + "^2 +" + b + ch11 + "-" + c + "$";
					break;
				case 3:
					Correct_ans = "$" + a + ch2 + "^2 -" + b + ch2 + "-" + c + "$";
					break;
				case 4:
					Correct_ans = "$" + a + ch3 + "^2 -" + b + ch3 + "$";
					break;
				case 5:
					Correct_ans = "$" + a + ch3 + "^2 +"  + c + "$";
					break;
				case 6:
					Correct_ans = "$" + a + ch1 + "^2 +" + b + ch1 + "$";
					break;
				case 7:
					Correct_ans = "$" + a + ch2 + "^2 -"  + c + "$";
					break;
				}
				...
				String Solution = "Ans: " + Correct_ans
						...
						+ Correct_ans
						+ " satisfies the above three conditions.<br>All the other options do not satisfy all conditions mentioned above simultaneously.<br>Hence the correct answer is "
						...
						+ Correct_ans
						+ " ही राशी या तीनही अटींची पूर्तता करते.  <br>इतर सर्व राशी या पैकी किमान एक तरी अट पूर्ण करत नाहीत. <br>म्हणून "
