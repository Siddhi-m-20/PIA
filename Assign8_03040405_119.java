...
public class Assign8_03040405_119 {
	public static Scanner sc = new Scanner(System.in);
	public static Random random = new Random();

	public static void main(String args[]) throws IOException, FileNotFoundException {
		String filename = "C:\\Siddhi\\Maths_Excelsheet\\VML_03040405_119_Assign8_Siddhi.xlsx";
		...
		do {
			...
			if (chr != chr1) {
				...
				String Question = "Find factors of following expression,<br> $" + hide1a(asqr, ch) + "^2" + "-"
						+ hide1a(bsqr, ch1) + "^2" + "$.<br># खालील राशीचे अवयव शोधा,<br>$" + hide1a(asqr, ch) + "^2"
						+ "-" + hide1a(bsqr, ch1) + "^2" + "$.<br>";
				String Correct_ans = " $(" + hide1a(a, ch) + "+" + hide1a(b, ch1) + ")(" + hide1a(a, ch) + "-"
						+ hide1a(b, ch1) + ")$ <br>";
				String wrong_ans1 = " $(" + hide1a(a, ch) + "+" + hide1a(b, ch1) + ")(" + hide1a(a, ch) + "+"
						+ hide1a(b, ch1) + ")$ <br>";
				String wrong_ans2 = " $(" + wrong_option(a) + ch + "+" + hide1a(b, ch1) + ")(" + wrong_option(a) + ch
						+ "+" + b + ch1 + ")$ <br>";
				String wrong_ans3 = " $(" + hide1a(a, ch) + "+" + wrong_option(b) + ch1 + ")(" + hide1a(a, ch) + "+"
						+ wrong_option(b) + ch1 + ")$ <br>";
				String wrong_ans4 = " $(" + hide1a((-a), ch) + "+" + hide1a(b, ch1) + ")(" + hide1a(a, ch) + "-"
						+ hide1a(b, ch1) + ")$ <br>";
				String wrong_ans5 = " $(" + hide1a(a, ch) + "-" + hide1a(b, ch1) + ")(" + hide1a(a, ch) + "-"
						+ hide1a(b, ch1) + ")$ <br>";
				String Solution = "Ans :   $(" + hide1a(a, ch) + "+" + hide1a(b, ch1) + ")(" + hide1a(a, ch) + "-"
						+ hide1a(b, ch1)
						...
						+ hide1a(asqr, ch) + "^2" + "-" + hide1a(bsqr, ch1) + "^2" + "$<br>$=(" + hide1a(a, ch)
						+ ")^2-(" + hide1a(b, ch1) + ")^2$<br>$=(" + hide1a(a, ch) + "+" + hide1a(b, ch1) + ")("
						+ hide1a(a, ch) + "-" + hide1a(b, ch1) + ")$ <br>$\\therefore (" + hide1a(a, ch) + "+"
						+ hide1a(b, ch1) + ")(" + hide1a(a, ch) + "-" + hide1a(b, ch1)
						+ ")$  ​​are required factors for the given binomial is the answer.<br> #उत्तर :  $("
						+ hide1a(a, ch) + "+" + hide1a(b, ch1) + ")(" + hide1a(a, ch) + "-" + hide1a(b, ch1)
						+ ")$ <br>आपण हे पाहू शकतो की दिलेली द्विपदी ही दोन पूर्ण वर्ग पदांची वजाबाकी आहे आणि<br>आपल्याला हे पण माहिती आहे की ​​​​$ a^2-b^2=(a+b)(a-b)$.<br>यावरून आपण हे सांगू शकतो की ​$(a+b)$ आणि $(a-b)$ हे $a^2-b^2$ याचे अवयव आहेत.<br>म्हणून आपण खालील प्रमाणे लिहू शकतो, <br>$"
						+ hide1a(asqr, ch) + "^2" + "-" + hide1a(bsqr, ch1) + "^2" + "$<br>$=(" + hide1a(a, ch)
						+ ")^2-(" + hide1a(b, ch1) + ")^2$<br>$=(" + hide1a(a, ch) + "+" + hide1a(b, ch1) + ")("
						+ hide1a(a, ch) + "-" + hide1a(b, ch1) + ")$<br>$\\therefore (" + hide1a(a, ch) + "+"
						+ hide1a(b, ch1) + ")(" + hide1a(a, ch) + "-" + hide1a(b, ch1)
						+ ")$ हे दिलेल्या द्विपदीचे अवयव आहेत हे उत्तर. <br>	";
...
//			row.createCell(17).setCellValue(" ");
				row.createCell(18).setCellValue(119);
