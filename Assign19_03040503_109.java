...
public class Assign19_03040503_109 {
	public static Scanner sc = new Scanner(System.in);
	public static Random random = new Random();

	public static void main(String args[]) throws IOException, FileNotFoundException {
		String filename = "C:\\Siddhi\\Maths_Excelsheet\\VLab_03040503_109_Assign19_Siddhi.xlsx";
		...
		do {
			...
			if (chr11 != chr && chr1 != chr2 && checkIfNoCommonFactor(a, b)) {
				...
				String Question = "Identify from the given set of polynomials in one variable as quadratic polynomials.<br>#खाली दिलेल्या बैजिक राशींपैकी कोणकोणत्या राशी एका चलातील वर्ग बहुपदी आहेत?<br>";
				String Correct_ans1 = "";
				String Correct_ans2 = "";
				int corr = random.nextInt(4);
				switch (corr) {
				case 0:
					Correct_ans1 = "$" + a + ch + "^2 +" + b + ch + "+" + c + "$";
					Correct_ans2 = "$" + d + ch11 + "^2 -" + e + ch11 + "$";
					break;
				case 1:
					Correct_ans1 = "$" + a + ch1 + "^2 -" + b + ch1 + "+" + c + "$";
					Correct_ans2 = "$" + d + ch3 + "^2 +" + e + "$";
					break;
				case 2:
					Correct_ans1 = "$" + a + ch11 + "^2 +" + b + ch11 + "-" + c + "$";
					Correct_ans2 = "$" + d + ch2 + "^2 +" + e + ch2 + "$";
					break;
				case 3:
					Correct_ans1 = "$" + a + ch3 + "^2 -" + b + ch3 + "-" + c + "$";
					Correct_ans2 = "$" + d + ch2 + "^2 -" + e + "$";
					break;
				}
				String wrong_ans1 = "$" + f + ch + "+" + b + "-" + c + ch11 + "$<br>";
				String wrong_ans2 = "$" + g + ch11 + "^2 -" + c + ch + "-" + h + "$<br>";
				String wrong_ans3 = "$" + b + ch1 + "^3+" + f + ch2 + "+" + g + "$<br>";
				String wrong_ans4 = "$" + h + ch3 + "+" + d + ch3 + "^2-" + k + ch3 + "^3$<br>";
				String wrong_ans5 = "$" + c + ch + "^2 +" + k + ch11 + "$<br>";
				String wrong_ans6 = "$" + k + ch2 + "-" + g + ch1 + "+" + h + "$<br>";

				String Solution = "Ans $1$ :  " + Correct_ans1 + " <br>Ans $2$ :  " + Correct_ans2
						+ " <br>According to the definition, for any algebraic expression to be a quadratic polynomial in one variable, it must be in one variable only and the highest power of the variable must be $2$. <br> Accordingly, we can see that, as per definition only  "
						+ Correct_ans1 + " and " + Correct_ans2
						+ "   are the polynomials which satisfy the given conditions. <br>Both of them are in $1$ variable and the highest power of the variable is $2$.<br>"
						+ "Of the remaining, either they are not in one variable or the degree of the polynomial is not $2$.<br>$\\therefore$ Answer $1$ :  "
						+ Correct_ans1 + ".<br>Answer $2$ :  " + Correct_ans2 + ".<br>#उत्तर  $1:$   " + Correct_ans1
						+ "<br>उत्तर  $2:$  " + Correct_ans2
						+ " <br>कोणतीही बैजिक राशी एका चलातील वर्ग बहुपदी असण्यासाठी, तिच्यात एकच चल असायला हवा आणि यातील चलाचा सगळ्यात मोठा घातांक $2$ असायला हवा. <br> या नुसार आपल्याला हे लक्षात येते की, फक्त  "
						+ Correct_ans1 + "  आणि " + Correct_ans2
						+ " या दोनच बहुपदी एका चलातील वर्ग बहुपदी आहेत.<br>कारण या दोन्ही राशी एकाच चलातील आहेत आणि त्यातील चलाचा मोठ्या मोठा घातांक $2$ आहे.<br>उरलेल्या राशी पैकी, एकतर त्यांचा घातांक $2$ नाही किंवा त्यात एकापेक्षा जास्त चल आहेत.<br>$\\therefore$   उत्तर  $1: $"
