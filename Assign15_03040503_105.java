...
public class Assign15_03040503_105 {
	public static Scanner sc = new Scanner(System.in);
	public static Random random = new Random();

	public static void main(String args[]) throws IOException, FileNotFoundException {
		String filename = "C:\\Siddhi\\Maths_Excelsheet\\VML_03040503_105_Assign15_Siddhi.xlsx";
		...
		do {
			...
			if (chr11 != chr && chr1 != chr2 && checkIfNoCommonFactor(a, b)) {
				...
				String Question = "Identify cubic polynomial in one variable from the following expressions.<br>#खाली दिलेल्या बैजिक राशींमधून अशी राशी शोधा जी एका चलातील घन बहुपदी आहे.<br> ";
				String Correct_ans = "";
				int corr = random.nextInt(6);
				switch (corr) {
				case 0:
					Correct_ans = "$" + ch + "^3 +" + b + ch + "^2 +" + c + ch + "+" + d + "$";
					break;
				case 1:
					Correct_ans = "$" + a + ch11 + "^3 -" + b + ch11 + "^2 -" + d + "$";
					break;
				case 2:
					Correct_ans = "$" + ch1 + "^3  -" + c + ch1 + "+" + d + "$";
					break;
				case 3:
					Correct_ans = "$" + a + ch2 + "^3 +" + b + ch2 + "^2 -" + c + ch2 + "$";
					break;
				case 4:
					Correct_ans = "$" + ch3 + "^3 -" + b + ch3 + "^2 -" + c + ch3 + "+" + d + "$";
					break;
				case 5:
					Correct_ans = "$" + a + ch + "^3 " + "-" + d + "$";
					break;
				}
				...
				String Solution = "Ans: " + Correct_ans
						...
						+ Correct_ans
						+ " satisfies all the above three conditions simultaneously.<br> All remaining options do not satisfy at least one of the given three conditions.<br> Hence the correct answer is "
						...
						+ Correct_ans
						+ " ही राशी दिलेल्या तीनही अटींची पूर्तता करते.  <br>इतर सर्व राशी या दिलेल्या तीनही अटींपैकी किमान एका अटीची तरी पूर्तता करत नाही.<br>म्हणून "
